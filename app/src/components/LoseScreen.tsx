...
export function LoseScreen({ showGaveUpScreen, onClose, gameState, neighborhoodsDict, optimalRoute }: LoseScreenProps) {
    const emoji_dict = {
        [ColorCodes.Good]: '🟩',
        [ColorCodes.Bad]: '🟥',
        [ColorCodes.Close]: '🟧',
    ...
    var text_to_copy = `I just finished today's daily burrow!\n${emoji_string}`
    ...
    return (
        <Dialog open={showGaveUpScreen} onClose={onClose}>
            <div
                style={{
                    position: 'fixed',
                    inset: 0,
